...
export { AdGuardProvider, HomepageProvider, ImmichProvider, MemosProvider, MinifluxProvider, NtfyProvider, OllamaProvider, PaperlessProvider, SablierProvider, StirlingProvider };
...
if (!registry.get('homepage')) {
  registry.register(new HomepageProvider());
}
